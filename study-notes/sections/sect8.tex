...
&\overset{
\text{\labelcref{it:mrl-exp-sl-relation}}}{=}\vatr{\alpha}{X}+\frac{\esf{\alpha}{X}}{1-F_X(\vatr{\alpha}{X})}\\
&=\vatr{\color{violet}F_X(\vatr{\alpha}{X})}{X}+\frac{1}{1-{\color{violet}F_X(\vatr{\alpha}{X})}}
\cdot \esf{\color{violet}F_X(\vatr{\alpha}{X})}{X}\\
&\overset{\text{\labelcref{it:tvar-var-esf}}}{=}\tvar{\color{violet}F_X(\vatr{\alpha}{X})}{X}.
\end{align*}
...
\begin{pf}
Apply \labelcref{it:cte-tvar} and then \labelcref{it:tvar-var-esf}. Next, note
that
\[
