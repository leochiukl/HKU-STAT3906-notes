...
\newcommand*{\probtheta}[1]{\mathbb{P}_{\theta}\left(#1\right)}
\newcommand*{\expvtheta}[1]{\mathbb{E}_{\theta}\left[#1\right]}
\newcommand*{\pois}[1]{\operatorname{Poi}\left(#1\right)}
\newcommand*{\gam}[1]{\operatorname{Gamma}\left(#1\right)}
\newcommand*{\nb}[1]{\operatorname{NB}\left(#1\right)}
\newcommand*{\geo}[1]{\operatorname{Geom}\left(#1\right)}
...
\newcommand*{\etnb}[1]{\operatorname{ETNB}\left(#1\right)}
\newcommand*{\vatr}[2]{\operatorname{VaR}_{#1}\left(#2\right)}
\newcommand*{\cte}[2]{\operatorname{CTE}_{#1}\left(#2\right)}
\newcommand*{\tvar}[2]{\operatorname{TVaR}_{#1}\left(#2\right)}
\newcommand*{\esf}[2]{\operatorname{ESF}_{#1}\left(#2\right)}
